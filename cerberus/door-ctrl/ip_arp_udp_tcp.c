...
const unsigned char IPHDR[] PROGMEM ={0x45,0,0,0x82,0,0,0x40,0,0x20}; // 0x82 is the total len on ip, 0x20 is ttl (time to live)
#endif
#ifdef NTP_client
...
void fill_buf_p(uint8_t *buf,uint16_t len, const unsigned char *progmem_s)
{
        while (len){
